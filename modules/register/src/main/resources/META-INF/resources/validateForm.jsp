<script>
    ...
    function eventListener() {
        ...
        lastname.addEventListener('blur', e => {
            if (e.target.classList.contains('idape')) {
    ...
    function showErrorName(msg) {
        ...
        mensajeErrorName.classList.add('f_size', 'label-nom-ape', 'text-left', 'm-top-msg', 'has-error');
    ...
    function showErrorLastName(msg) {
        ...
        mensajeErrorLast.classList.add('f_size', 'label-nom-ape', 'text-left', 'm-top-msg', 'has-error-last');
