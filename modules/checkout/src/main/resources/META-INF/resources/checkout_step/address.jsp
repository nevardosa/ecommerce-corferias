...
<%-- @taglib uri="cart_total/init.jsp" --%>
...
<div class="address-fields addresCheck">
	<div class="form-group-autofit" id="name">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="text" label="Nombres" name="name" placeholder="name" wrapperCssClass="form-group-item" />
	</div>
	<div class="form-group-autofit" id="lastName">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="text" label="Apellidos" name="lastName" placeholder="name" wrapperCssClass="form-group-item" />
	</div>
	<div class="form-group-autofit" id="phone">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="number" label="Telefono" name="phone" placeholder="phone-number" />
	</div>	
	<div class="form-group-autofit" id="email">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="email" label="Correo el�ctronico" name="email" placeholder="Correo el�ctronico" wrapperCssClass="form-group-item" />
	</div>
	<div class="form-group-autofit" id="depto">
		<aui:select disabled="<%= commerceAddressId > 0 %>" label="Departamento" name="commerceCountryId" placeholder="departamento" title="country" wrapperCssClass="form-group-item">
			<aui:validator errorMessage='<%= LanguageUtil.get(request, "please-enter-a-valid-country") %>' name="min">1</aui:validator>
		</aui:select>
	</div>	
	
	<div class="form-group-autofit">
		<aui:select disabled="<%= commerceAddressId > 0 %>" label="Ciudad" name="commerceRegionId" placeholder="region" title="region" wrapperCssClass="form-group-item" />
	...
	<div class="form-group-autofit">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="text" label="Barrio" name="neighborhood" placeholder="Barrio" wrapperCssClass="form-group-item" />
	</div>	
	<div class="form-group-autofit">
		<aui:input disabled="<%>= commerceAddressId > 0 %>" label="" name="street1" placeholder="Direcci�n" wrapperCssClass="form-group-item" />
	</div>
	...
	<div class="form-group-autofit">
		<aui:input disabled="<%= commerceAddressId > 0 %>" type="text" label="Torre/Apartamento/Conjunto/Oficina/Condominio" name="apto" placeholder="" wrapperCssClass="form-group-item" />
	</div>	
	<!-- div class="add-street-fields form-group-autofit hide">
